...
function drawChart() {
  ...
  data.addRows([
    ['Associate',       'Associate Applied Science, Computer Sec. - CCC', 'Education',              new Date(2017, 1, 20),    new Date(2018, 5, 20),  null, 100,  null],
    ...
    ['TC',              'College Teaching & Learning Sci. Cert. - UMBC',  'Education',              new Date(2021, 6, 1),     new Date(2022, 12, 15), null, 82,   null],
    ...
    ['InfoSec',         'Info. Sys. Sec. Asso. Student Chapter President','Leadership Experience',  new Date(2017, 3, 1),     new Date(2018, 5, 20),  null, 100,  null],
